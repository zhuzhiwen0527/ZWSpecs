#
# Be sure to run `pod lib lint XDBusinessModule.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'XDBusinessModule'
  s.version          = '0.1.1'
  s.summary          = 'A short description of XDBusinessModule.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'XDBusinessModule' => ['XDBusinessModule/Assets/*.png']
  # }
